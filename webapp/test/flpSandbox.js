		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cominctureui5week10assignment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominctureui5week10assignment-display": {
								"semanticObject": "cominctureui5week10assignment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.ui5.week10assignment",
									"url": sap.ui.require.toUrl("com/incture/ui5/week10assignment")
								}
							}
						}
					}
